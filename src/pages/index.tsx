    ...
    <div className="flex flex-col items-center justify-center">
      <div className="text-center mb-10 mt-5">
        <div className="font-bold text-4xl flex text-center justify-center items-center">
          <span className="mr-3">Gift</span>
          <Typewriter
            options={{
              strings: ["Airdrop", "Drop To Community", "Drop Telegram Bot"],
              autoStart: true,
              loop: true,
            }}
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl w-full px-4">
        ...
        >
          ...
          <div className="">
            ...
            <p className="mb-4">
              Let SuiGPT generate Sui Move smart contract code for you based on
              your instructions.
            </p>
          </div>
        </Link>
        ...
        >
          ...
          <div className="">
            ...
            <p className="mb-4">
              Use SuiGPT Gas Viewer and other incoming SuiGPT Developer Tool
